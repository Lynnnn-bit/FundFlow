...
<body>
    ...
    <div class="main-container">
        ...
        <!-- Add Retour Button -->
        <div class="button-container" style="text-align: center; margin-bottom: 1rem;">
            <a href="mesprojet.php" class="btn btn-secondary">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="titre" 
                           value="<?= $editMode ? htmlspecialchars($projectToEdit['titre']) : '' ?>" >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="montant_cible" min="10000" max="10000000" 
                           value="<?= $editMode ? $projectToEdit['montant_cible'] : '500000' ?>" >
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="duree" min="6" max="60" 
                           value="<?= $editMode ? $projectToEdit['duree'] : '24' ?>">
                </div>
